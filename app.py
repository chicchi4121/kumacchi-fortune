...
🌟総合運
{overall_stars}
[総合運の解説を100〜150文字で。占い師らしい前向きな文章。今日どんな一日になりそうか、背景や理由も含めて具体的に]

💕恋愛運
{love_stars}
[恋愛運の解説を100〜150文字で。具体的なシーンや相手との関わり方にも触れる]

💰金運
{money_stars}
[金運の解説を100〜150文字で。お金の使い方や入ってくるタイミングなど具体的に]

💼仕事運
{work_stars}
[仕事運の解説を100〜150文字で。職場での立ち回りや成果につながる具体的なヒントを含める]

🍀健康運
{health_stars}
[健康運の解説を100〜150文字で。体調管理のポイントや注意すべき時間帯など具体的に]
...
✨開運アドバイス
[120〜180文字で、今日一日を通した具体的な行動アドバイス。いつ・何をすると運気が上がるかまで踏み込む]
...
- 各解説は指定の文字数を必ず満たし、具体的で前向きな内容にする
- 占いは娯楽として提供する
- フォーマット以外の文章を追加しない\
"""
...
🌟総合相性
[100〜150文字で2人の総合的な相性。性格の相性や関係が深まる理由も含めて具体的に]

💕恋愛面
[100〜150文字で恋愛における相性。デートの相性やお互いへの接し方など具体的に]

💼協力・仕事面
[100〜150文字で協力関係における相性。役割分担やうまくいくコツなど具体的に]

🎁共通ラッキーアイテム
{item}

✨開運アドバイス
[2人へのアドバイスを120〜180文字で。関係を良くする具体的な行動まで踏み込む]
